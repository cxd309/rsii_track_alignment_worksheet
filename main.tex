...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{horizontal_curve_1}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{vertical_curve_1}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{vertical_curve_2}
    \caption{Horizontal curve worked example}
    \label{fig:hoz-cur-2}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{vertical_curve_3}
    \caption{Horizontal curve worked example}
    \label{fig:hoz-cur-3}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{vertical_curve_4}
    \caption{Horizontal curve worked example}
    \label{fig:hoz-cur-4}
\end{figure}
